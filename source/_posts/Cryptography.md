...
> <mark>Lemma</mark>: PRF Switching Lemma
>
...
> <mark>Theorem</mark>: (Luby-Rackoff '85) <a name='luby-rackoff'></a>
> $$
...
> <mark>Theorem</mark>: Given $\dfrac{1}{\epsilon^2}$ random $(m, c=\text{DES}(k, m))$ pairs, then
> $$
